...
export const newsArticle = pgTable(
  'news_articles',
  {
    ...
    authorName: text('author_name').notNull().default('Tim LebihJauh'),
    seoTitle: text('seo_title'),
    seoDescription: text('seo_description'),
    coverImageUrl: text('cover_image_url'),
    coverAltText: text('cover_alt_text').notNull().default(''),
    contentImageUrl: text('content_image_url'),
    contentImageAlt: text('content_image_alt').notNull().default(''),
    contentImageCaption: text('content_image_caption').notNull().default(''),
    relatedTripId: uuid('related_trip_id').references(() => trip.id, {
      onDelete: 'set null',
    }),
    socialUrl: text('social_url'),
    publicationState: text('publication_state').notNull().default('draft'),
